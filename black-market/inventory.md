...
Do not store `现场验货`, `常规描述`, raw image analysis, source filenames, paths, makeup, facial features, face shape, complexion, skin texture, or attractiveness judgments in formal stock.
