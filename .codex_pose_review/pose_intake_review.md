...
来源：桌面 `pose` 文件夹，59 张参考图。

状态：仅供审核，尚未写入 `black-market/inventory/pose.md`。

规则：只提取姿势、动作、身体朝向、重心、手臂/手势、道具互动和身体语言；不写服装、画风、脸、表情、身份、来源文件名或路径。半身、遮挡、动作不完整的参考，已补成可复用的完整身体动作。
...
- 审核编号: "P006"
  名称: "前压单手出牌"
  类别: "姿势"
  描述: "身体向前倾压，重心明显推进到前侧，单臂伸向镜头方向递出薄片状物，另一臂向后拉开平衡，像是在突然亮出凭证或发起行动。"
  标签:
    - "前压"
    - "单臂前伸"
    - "递出动作"
...
- 审核编号: "P020"
  名称: "倚刀叉腰斜站"
  类别: "姿势"
  描述: "身体斜向站立，重心偏在一条腿上，一手叉在腰侧，另一手握住长形物靠近身体，像是在战斗间隙放松但仍保留攻击准备。"
  标签:
    - "斜站"
    - "叉腰"
    - "长形物握持"
...
- 审核编号: "P030"
  名称: "半身补完举食停步"
  类别: "姿势"
  描述: "身体正面停步站立，重心偏向一侧，一手抬到胸前握住小物，另一手放松垂在身旁，补完整体为随意驻足的单手展示动作。"
  标签:
    - "补完整身"
    - "停步"
    - "举物"
...
- 审核编号: "P037"
  名称: "站姿双手握杯"
  类别: "姿势"
  描述: "身体正面自然站立，重心偏向一条腿，双手在胸腹前共同握住小型容器，像是在停步休息并把手部动作收回身体中心。"
  标签:
    - "自然站"
    - "双手握物"
    - "中心收拢"
...
- 审核编号: "P040"
  名称: "屈膝捧物后撤"
  类别: "姿势"
  描述: "身体向后缩并降低重心，双膝弯曲，一手或双手护住胸前小物，双肘收紧，像是在紧张后撤中保护手中东西。"
  标签:
    - "屈膝"
    - "后撤"
    - "护物"
...
- 审核编号: "P051"
  名称: "肩扛重器斜站"
  类别: "姿势"
  描述: "身体正面偏侧站立，双脚分开形成稳定底盘，单手将重型长柄物扛在肩上，另一手垂在身体侧边，像是在战斗前展示力量储备。"
  标签:
    - "肩扛"
    - "重器"
    - "稳定底盘"
