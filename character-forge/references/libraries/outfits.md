...
- base_layer: plain white short-sleeve shirt
...
- outerwear: navy security jacket
- base_layer: light blue button-up shirt
...
- outerwear: lightweight zip jacket
- base_layer: checked short-sleeve shirt
...
- outerwear: short suit jacket
- base_layer: patterned shirt
...
- outerwear: gray utility blazer
- base_layer: pale polo shirt
- pants: navy chinos
- socks: black socks
...
- outerwear: burgundy service vest
- base_layer: crisp white shirt
...
- outerwear: black field vest
- base_layer: charcoal shirt
...
- outerwear: linen mandarin-collar jacket
- base_layer: soft cotton undershirt
