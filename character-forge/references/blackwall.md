...
- If Tony or Azoth is making a stronger, heavier, more dangerous, heroic, wild, hard-edged, or high-pressure male face, did they express it through broad stylized structure rather than narrowness or realism: broad jaw, wide lower face, solid blunt chin, full cheek structure, thick straight/blocky eyebrows, firm mouth line, direct gaze, and controlled eye highlights?
- Does Azoth preserve large anime eyes and the WHOWHO eye style when adding brow pressure, facial tension, tiredness, low tension, quiet expressions, or stronger face structure, with explicit protection against small eyes, narrow slit eyes, squinting, half-lidded eyes, heavy-lidded eyes, droopy eyelids, sleepy eyes, realistic eyes, or style shift?
...
- Does the character preserve a visible clean white fitted tank top or clean white fitted inner T-shirt as the torso base layer, unless the user explicitly requested a different visible base layer, bare torso, fully covering armor, or heavy outerwear?
- Does the white fitted torso base layer visibly wrap the chest and abdominal muscle contour with clean animation lines, unless the user explicitly requested otherwise?
...
- If `black-market/inventory/styling/items/bottoms.md` exists, did San Zhai check it before finalizing `pants`, and is the pants field a concrete bottom structure rather than generic pants/shorts/trousers wording?
...
- Did Tony apply grooming cooldown to hairstyle, static eyebrow shape, beard state, and broad face shape, hard-excluding the last 3 recent values in each domain when alternatives exist, strongly downweighting the last 10, and recording cooldown handling in `grooming_reason` or `黑商取货`?
...
- Did Azoth apply expression cooldown after pose selection, avoiding the last 3 recent expression stock names and near-duplicate performance beats when alternatives exist, strongly downweighting the last 10, and recording cooldown handling?
...
- face-strength wording that makes the character leaner or changes the art style, including pointed chin, V-shaped face, narrow face, narrow cheekbones, long face, slender oval face, tough guy, rugged man, hard-boiled man, masculine face, realistic rugged face, rough skin, weathered face, gritty skin texture, stubble added only to signal toughness, 欧美漫画脸, 写实硬汉, 小眼硬汉, 尖下巴, V脸, 窄脸, 窄颧骨, 长脸, 过窄鹅蛋脸, 粗糙皮肤, 沧桑写实脸, or any similar wording unless the user explicitly asks for that exact direction
- prompt wording that shrinks or hides the WHOWHO anime eyes, including small eyes, narrow slit eyes, squinting eyes, half-lidded eyes, heavy-lidded eyes, droopy eyelids, sleepy eyes, tiny pupils, cute round baby eyes when the character should not become soft, overly glossy innocent eyes, realistic eyes, style-shifted eyes, 小眼睛, 眯缝眼, 半闭眼, 眼皮下垂, 困倦眼, 细长眼, 写实眼睛, or 画风漂移
...
- missing clean white fitted tank top or clean white fitted inner T-shirt when no explicit user override or fully covering outfit requirement exists
...
- San Zhai output that leaves `pants` as generic `裤子`, `裤装`, `普通长裤`, `普通短裤`, `pants`, `trousers`, or `shorts` while `items/bottoms.md` has viable formal bottom stock, or omits the bottom-stock check from `黑商取货`
...
Strong-face distinction: broad square jaws, wide lower faces, solid blunt chins, full cheek structure, thick straight eyebrows, direct gaze, normal-open readable anime eyes, firm mouth lines, and controlled highlights are allowed and preferred for stronger male reads. Reject only when this turns into narrow/pointed/long facial slimming, realistic ruggedness, rough skin, small eyes, half-lidded or sleepy eyes, or a non-WHOWHO art style.
