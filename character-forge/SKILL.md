...
- 阿佐特：preserve WHOWHO anime eyes in the final prompt when adding brow pressure or stronger face structure. Use compact protection such as `large expressive eyes, same eye size, same anime eye style, wide eye opening, straight upper eyelids, firm lower eyelids, focused pupils, direct gaze, controlled highlights`, plus negative constraints against small eyes, narrow slit eyes, squinting, realistic eyes, and style shift.
- 黑墙：reject any face or prompt wording that turns strength into facial slimming, small eyes, rough realism, weathered skin, or non-WHOWHO art style unless the user explicitly asks for that exact direction.
